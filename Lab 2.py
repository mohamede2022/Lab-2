...
#This itteration checks if the input the user gave for lab grade is < or > 100 and then assign them accordingly
if user_lab < 0:
      user_lab = 0
...
#This if-else statements checks if the input the user gave for exams grade is < or > 100 and then assign them accordingly
if user_exam < 0:
      user_exam = 0
...
#This if-else statements checks if the input the user gave for attendance grade is < or > 100 and then assign them accordingly
